...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # it accepts a starting value, then a block, and it runs the block on each item in the array, carrying forward
    # the return value of the block as the "starting value" of the next block execution 
  end
  ...
  # I think it is so that the file will automatically be closed
