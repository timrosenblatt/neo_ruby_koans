...
class AboutClassMethods < Neo::Koan
  ...
  # I've never fully understood the difference. I've always preferred the self.method version since it makes things very clear, but the << method seems to allow more nuanced control over protected methods
