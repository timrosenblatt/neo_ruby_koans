...
class AboutSymbols < Neo::Koan
  ...
  # so that it doesn't pollute the pool of symbols. the preprocessor 
  # would generate the symbol that we were trying to test
  ...
  # as opposed to being different from strings? maybe symbols are treated differently
  # in the interpreter? does it pollute the object pool?
end
